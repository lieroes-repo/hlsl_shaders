//!Largely provided in lab week 7 base application!
//Added extra weights and used gaussian blur values to render the blur

Texture2D shaderTexture : register(t0); //RenderTexture received from HorizontalBlurShader
